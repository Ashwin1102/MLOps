...
async def predict_diabetes(diabetes_features: DiabetesData):
    try:
        features = [[diabetes_features.age, diabetes_features.sex, diabetes_features.bmi, diabetes_features.bp,
                     diabetes_features.s1, diabetes_features.s2, diabetes_features.s3, diabetes_features.s4,
